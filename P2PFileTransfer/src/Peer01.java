...
public class Peer01 {
    ...
    private static Integer[] connectedPeers01Ports = new Connections().getPeer01ConnectionPorts();
    ...
    private static String path = new Connections().getPath();
...
//        R1.start();
        ...
        while(true){
            System.out.println(path+ "Server(S) || Client(C): ");
            ...
            if(input.equalsIgnoreCase("S")){
                ...
                requestFile(fileName, connectedPeers01Ports);
    ...
    private static boolean requestFile(String fileName, Integer[] connectedPeers) throws IOException, InterruptedException {
        ...
        for (int portNo : connectedPeers) {
            ...
            if(serverData.contains("Yes")){
                ...
                int myPort = 1111;
                byte[] buff = Integer.toString(myPort).getBytes();
                System.out.println("Sending data to port: "+portNo+"\nBuffer: "+ Arrays.toString(buff));
                ...
                String fileNameNew = "F:\\ItelliJ\\Projects\\P2PFileTransfer\\src\\Peer01Files\\"+fileName;
    ...
    private static void server(DatagramSocket serverSocket) throws IOException, InterruptedException {
        ...
        //check if current peer(peer01) has the file or not
        String filename = "F:/ItelliJ/Projects/P2PFileTransfer/src/Peer01Files/"+clientData;
        String actualFileName = clientData.trim();
        ...
        if(file.exists()){
            ...
            boolean isFileFound = requestFile(actualFileName, connectedPeers01Ports);
            if(isFileFound){
                serverData = "Yes";
