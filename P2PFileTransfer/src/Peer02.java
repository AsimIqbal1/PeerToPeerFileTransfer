...
public class Peer02 {
    ...
    private static Integer[] connectedPeers02Ports = new Connections().getPeer02ConnectionPorts();
...
//        R1.start();
        ...
        while(true){
            ...
            if(input.equalsIgnoreCase("S")){
                ...
                requestFile(fileName, connectedPeers02Ports);
    ...
    private static boolean requestFile(String fileName, Integer[] connectedPeers) throws IOException, InterruptedException {
        ...
        for (int portNo : connectedPeers) {
            ...
            if(serverData.contains("Yes")){
                ...
                String fileNameNew = "F:\\ItelliJ\\Projects\\P2PFileTransfer\\src\\Peer02Files\\"+fileName;
    ...
    private static void server(DatagramSocket serverSocket) throws IOException, InterruptedException {
        ...
        //check if current peer(peer02) has the file or not
        String filename = "F:/ItelliJ/Projects/P2PFileTransfer/src/Peer02Files/"+clientData;
        ...
        if(file.exists()){
            ...
            boolean isFileFound = requestFile(actualFileName, connectedPeers02Ports);
            if(isFileFound){
                serverData = "Yes";
...
//
//                DatagramPacket receivedPacket3
//                        = new DatagramPacket(receiveBuffer2, receiveBuffer2.length);
//                serverSocket.receive(receivedPacket3);
