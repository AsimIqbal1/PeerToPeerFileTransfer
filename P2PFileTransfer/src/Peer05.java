...
public class Peer05 {
    ...
    private static Integer[] connectedPeers05Ports = new Connections().getPeer05ConnectionPorts();
...
//        R1.start();
        ...
        while(true){
            ...
            if(input.equalsIgnoreCase("S")){
                ...
                requestFile(fileName, connectedPeers05Ports);
    ...
    private static boolean requestFile(String fileName, Integer[] connectedPeers) throws IOException, InterruptedException {
        ...
        for (int portNo : connectedPeers) {
            ...
            if(serverData.contains("Yes")){
                ...
                String fileNameNew = "F:\\ItelliJ\\Projects\\P2PFileTransfer\\src\\Peer05Files\\"+fileName;
    ...
    private static void server(DatagramSocket serverSocket) throws IOException, InterruptedException {
        ...
        //check if current peer(peer05) has the file or not
        String filename = "F:/ItelliJ/Projects/P2PFileTransfer/src/Peer05Files/"+clientData;
        ...
        if(file.exists()){
            ...
            boolean isFileFound = requestFile(actualFileName, connectedPeers05Ports);
            if(isFileFound){
                serverData = "Yes";
