...
public class Peer03 {
    ...
    private static Integer[] connectedPeers03Ports = new Connections().getPeer03ConnectionPorts();
...
//        R1.start();
        ...
        while(true){
            ...
            if(input.equalsIgnoreCase("S")){
                ...
                requestFile(fileName, connectedPeers03Ports);
    ...
    private static boolean requestFile(String fileName, Integer[] connectedPeers) throws IOException, InterruptedException {
        ...
        for (int portNo : connectedPeers) {
            ...
            if(serverData.contains("Yes")){
                ...
                String fileNameNew = "F:\\ItelliJ\\Projects\\P2PFileTransfer\\src\\Peer03Files\\"+fileName;
    ...
    private static void server(DatagramSocket serverSocket) throws IOException, InterruptedException {
        ...
        //check if current peer(peer03) has the file or not
        String filename = "F:/ItelliJ/Projects/P2PFileTransfer/src/Peer03Files/"+clientData;
        ...
        if(file.exists()){
            ...
            boolean isFileFound = requestFile(actualFileName, connectedPeers03Ports);
            if(isFileFound){
                serverData = "Yes";
